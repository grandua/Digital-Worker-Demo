...
public sealed class WindowsApplicationTests : ConformanceTests
{
    ...
    private string CodeBehindSource => Repo.Read("Presentation", "SciCalc.Maui", "Platforms", "Windows", "App.xaml.cs");

    [Fact]
    public void AppXaml_RootsMauiWinUIApplicationWithClassDirective()
    {
        XDocument xaml = Repo.Xml("Presentation", "SciCalc.Maui", "Platforms", "Windows", "App.xaml");
