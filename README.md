...
Features true OOP / Rich Domain Model architecture. ~2,000 LOC across 46 files with 230 domain unit tests. Production domain code achieves **99.6% line coverage** and **95.4% branch coverage** (only 4 lines and 15 branches uncovered across the entire domain).
