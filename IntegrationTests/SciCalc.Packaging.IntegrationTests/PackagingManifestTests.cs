...
public sealed class PackagingManifestTests : ConformanceTests
{
    ...
    private XDocument Project => Repo.Xml("Presentation", "SciCalc.App", "SciCalc.App.csproj");

    private XDocument Manifest => Repo.Xml("Presentation", "SciCalc.App", "Platforms", "Windows", "Package.appxmanifest");
    ...
    {
        Assert.NotEmpty(Repo.Dir("Presentation", "SciCalc.App", "Resources", folder).EnumerateFiles());
    }
    ...
    private void AssertUnderResources(string include)
    {
        ...
        Assert.True(source.Exists, $"'{include}' must resolve to an existing file under Presentation/SciCalc.App/Resources/.");
    }
    ...
    private FileInfo ResolveProjectAsset(string include)
    {
        ...
        string[] path = ["Presentation", "SciCalc.App", .. segments];
    ...
    private FileInfo ManifestAssetFile(string? value)
    {
        ...
        string[] segments = ["Presentation", "SciCalc.App", "Platforms", "Windows", .. relative.Split(Path.DirectorySeparatorChar)];
