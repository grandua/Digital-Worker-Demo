...
{
    private const string MainApplicationPath = "Presentation/SciCalc.App/Platforms/Android/MainApplication.cs";

    private string MainApplicationSource => Repo.Read("Presentation", "SciCalc.App", "Platforms", "Android", "MainApplication.cs");

    [Fact]
    public void MainApplication_Exists()
    {
        Assert.True(Repo.File("Presentation", "SciCalc.App", "Platforms", "Android", "MainApplication.cs").Exists,
